...
V = 1.05 + ...
-0.0016 *  ( ( ( (20.0 .* ((x1*0.0 * 1.0 + x2*0.0 * 1.0 + x3*1.0 * 1.0 + x4*0.0 * 1.0 + x5*0.0 * 1.0 + 0.0 * 1.0)))  -  (21.0 - ((x1*0.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + x4*0.0 * 1.0 + x5*1.0 * 1.0 + 0.0 * 1.0))) )  .* -31.25) )  + ...
0;

% MSE = 9.15999947743434E-18
