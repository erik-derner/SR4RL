...
V = -39430.2463311 + ...
0.05 *  ( ( (-6.0484964 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + 0.9751184) )  + ...
1.0 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 20592.25)  - -18838.25) )  + ...
0;

% MSE = 8.526918183368595E-18
