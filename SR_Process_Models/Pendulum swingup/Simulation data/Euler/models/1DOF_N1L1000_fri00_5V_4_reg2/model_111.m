...
V = 693.84017938 + ...
0.05 *  ( ( ( (0.0 +  (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 648.0) )  + 0.06237819)  - 268.86596579) )  + ...
1.0 *  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 648.0) )  + ...
0;

% MSE = 8.527184319055852E-18
