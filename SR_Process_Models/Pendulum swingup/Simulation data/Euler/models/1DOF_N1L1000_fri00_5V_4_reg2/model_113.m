...
V = -4511.65202498 + ...
0.025 *  ( ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* 2.0)  - -0.882494) )  + ...
1.0 *  ( (-1128.96 +  (5640.58996263 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 8.527086337194524E-18
