...
V = 168771.90555461 + ...
0.05 *  ( (0.64401037 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
1.0 *  ( ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + -810.33775513)  - 83980.8)  - 83980.8) )  + ...
0;

% MSE = 8.521965238330734E-18
