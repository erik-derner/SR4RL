...
V = 87644.01434144 + ...
1.05 *  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 1.0) )  + ...
-1.0 *  ( ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) -  (-87652.0 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  - 9.03565856) )  + ...
0;

% MSE = 8.524410488556057E-18
