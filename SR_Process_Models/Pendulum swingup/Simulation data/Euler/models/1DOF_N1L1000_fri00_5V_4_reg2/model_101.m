...
V = -12.49090841 + ...
0.018 *  ( ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* 2.77777778)  + -1.0) )  + ...
-0.03125 *  ( ( (-4.6951757 +  (16.0 .*  (-2.0 .*  (12.24744871 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) )  - 3.67153457) )  + ...
0;

% MSE = 8.527194846277487E-18
