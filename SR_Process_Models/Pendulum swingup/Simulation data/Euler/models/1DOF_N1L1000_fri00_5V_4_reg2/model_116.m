...
V = -1023.76866435 + ...
0.1 *  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) -  ( (0.5 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  - 0.28571429) ) )  + ...
1.0 *  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - -1023.74009292) )  + ...
0;

% MSE = 8.52716396730208E-18
