...
V = -0.075 + ...
75.93749991 *  ( ( (0.02566001 .*  (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 1.5) )  .* 0.02566001) )  + ...
38.9796967 *  ( (0.02565438 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
0;

% MSE = 4.693812514341055E-18
