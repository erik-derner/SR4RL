...
V = -0.025 + ...
-0.05271797 *  ( (-0.9484432 .*  (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - -0.5) ) )  + ...
140.50335152 *  ( (0.00711727 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
0;

% MSE = 4.698505406683514E-18
