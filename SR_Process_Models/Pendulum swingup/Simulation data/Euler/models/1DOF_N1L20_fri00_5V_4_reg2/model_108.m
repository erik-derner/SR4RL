...
V = 0.48125 + ...
5381.65511371 *  ( ( (0.375 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  .* 9.29E-6) )  + ...
-386.62166945 *  ( (-0.00258651 .*  (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 0.5) ) )  + ...
0;

% MSE = 4.693759460537955E-18
