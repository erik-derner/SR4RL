...
V = -7022.48254138 + ...
-351.11822443 *  ( (-1.424E-4 .*  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - -1.3608734)  + 1.0) ) )  + ...
-7022.36449771 *  ( (-1.0 +  (-1.424E-4 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 4.6926518877923386E-18
