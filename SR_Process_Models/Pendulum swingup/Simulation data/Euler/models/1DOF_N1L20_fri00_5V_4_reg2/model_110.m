...
V = 48.79371772 + ...
210.66425205 *  ( ( (-0.01540599 .*  ( (4.0 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  .* -0.01540599) )  - 0.31111935) )  + ...
-1.0 *  ( (-17.5 +  (0.9519915 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 4.729814405404743E-18
