...
V = -59050.16533434 + ...
-492.08408633 *  ( (-1.0161E-4 .*  (1.5 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
-9841.68172239 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* -1.0161E-4)  + -6.0) )  + ...
0;

% MSE = 4.674142037050364E-18
