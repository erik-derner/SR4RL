...
V = 165.06968505 + ...
0.05 *  ( ( (-151.393701 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-1.05 *  ( ( (-4.0 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + 154.0) )  + ...
0;

% MSE = 5.4618386227277766E-18
