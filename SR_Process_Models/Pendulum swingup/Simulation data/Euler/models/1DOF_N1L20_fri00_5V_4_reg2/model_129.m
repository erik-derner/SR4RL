...
V = 21.05 + ...
0.95 *  ( (1.0 - ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-2.0 *  ( ( ( ( (1.0 .*  (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  .* -1.0)  .* 0.5)  + 11.0) )  + ...
0;

% MSE = 4.780064374817283E-18
