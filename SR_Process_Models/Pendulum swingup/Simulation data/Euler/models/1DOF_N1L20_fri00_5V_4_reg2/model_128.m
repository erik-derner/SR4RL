...
V = 0.0 + ...
-78.39999991 *  ( (-6.3776E-4 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-368.44291517 *  ( (0.12562997 .*  (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* -0.02160412) ) )  + ...
0;

% MSE = 4.6994552441959476E-18
