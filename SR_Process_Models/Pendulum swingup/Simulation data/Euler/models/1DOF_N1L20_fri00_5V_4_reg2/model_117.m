...
V = -20.06255999 + ...
-1.40161528 *  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* -0.03567313) )  + ...
1.0 *  ( (10.03127999 +  (10.03127999 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 4.726094025038388E-18
