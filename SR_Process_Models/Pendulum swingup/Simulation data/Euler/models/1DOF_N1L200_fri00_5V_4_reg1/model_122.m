...
V = 14.8125 + ...
0.0125 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) +  (4.0 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  -  (-79.0 .*  (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + -15.0) ) ) )  + ...
0;

% MSE = 8.211250811969547E-18
