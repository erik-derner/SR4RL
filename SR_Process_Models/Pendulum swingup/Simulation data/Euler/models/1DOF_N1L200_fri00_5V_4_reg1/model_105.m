...
V = 27.73449788 + ...
-0.99999864 *  ( (25.56668129 -  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* 0.05000802)  +  (-2.16789322 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) )  + ...
0;

% MSE = 1.4426849301119993E-8
