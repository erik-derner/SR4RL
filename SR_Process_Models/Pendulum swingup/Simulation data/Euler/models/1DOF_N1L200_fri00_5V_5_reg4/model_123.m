...
V = 89.30038025 + ...
-8.37004302 *  ( (((x1*0.0 * 1.0 + x2*0.0 * 1.0 + x3*1.0 * 1.0 + 0.0 * 1.0)) .* -0.18790299) )  + ...
-89.30038025 *  ( ( ( sin(((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  .* 0.0707372)  - -1.0) )  + ...
-0.2369404 *  ( sign(((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-27.53261996 *  ( (0.87758256 .*  (-0.03767432 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 2.1447194611272209E-16
