...
V = 202815.92514918 + ...
-0.05 *  ( (-0.64103086 -  (2.0 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
-1.0 *  ( ( (316.05720072 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + 202500.0) )  + ...
0;

% MSE = 8.185089193878713E-18
