...
V = -418.07878681 + ...
0.08 *  ( (0.98483513 -  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  .* -0.625) ) )  + ...
0.95 *  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 440.0) )  + ...
0;

% MSE = 8.186419104793264E-18
