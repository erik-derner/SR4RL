...
V = 6402.2 + ...
855.97211196 *  ( (-6.1023E-4 .*  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 20.0)  .* -0.09572355) ) )  + ...
1.0 *  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + -6403.2) )  + ...
0;

% MSE = 8.180725439069837E-18
