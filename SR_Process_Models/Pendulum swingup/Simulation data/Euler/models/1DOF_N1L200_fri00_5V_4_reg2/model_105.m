...
V = -1.08121104 + ...
-0.05 *  ( ( (-0.20741363 -  (1.14720269 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + -1.0) )  + ...
1.0 *  ( (0.96348022 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
0;

% MSE = 8.186445157456453E-18
