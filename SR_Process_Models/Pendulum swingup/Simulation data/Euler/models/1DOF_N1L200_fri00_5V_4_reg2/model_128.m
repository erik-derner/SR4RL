...
V = -1075.4021604 + ...
0.05 *  ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) +  (0.4 +  ( (0.2 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + -0.756792) ) ) )  + ...
1.05 *  ( (0.2 +  (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 1024.0) ) )  + ...
0;

% MSE = 8.18632947898314E-18
