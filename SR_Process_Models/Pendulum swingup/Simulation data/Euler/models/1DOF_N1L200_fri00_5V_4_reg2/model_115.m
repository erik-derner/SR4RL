...
V = 0.05657321 + ...
0.05 *  ( (4.0 -  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  - 0.07032652) ) )  + ...
1.05 *  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 0.24770432) )  + ...
0;

% MSE = 8.186446403529714E-18
