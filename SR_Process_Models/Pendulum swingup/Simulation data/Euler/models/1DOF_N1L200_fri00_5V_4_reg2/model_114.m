...
V = -40.17015871 + ...
0.05 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + 768.0) )  + ...
0.19 *  ( ( (5.0 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + 9.31662479) )  + ...
0;

% MSE = 8.186539747260647E-18
