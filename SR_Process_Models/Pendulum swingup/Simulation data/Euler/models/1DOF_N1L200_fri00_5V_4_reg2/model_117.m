...
V = -2304.81493014 + ...
0.05 *  ( (2.47804354 +  ( ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 1.86599615)  + -0.16935431)  + 12.12391743) ) )  + ...
-1.0 *  ( (-2304.0 - ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
0;

% MSE = 8.186405578458832E-18
