...
V = -5033.35 + ...
112.80000001 *  ( (-1.0 .*  (-0.01196809 +  (-4.4326E-4 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) )  + ...
1.0 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 729.0)  - -5761.0) )  + ...
0;

% MSE = 8.18039575971478E-18
