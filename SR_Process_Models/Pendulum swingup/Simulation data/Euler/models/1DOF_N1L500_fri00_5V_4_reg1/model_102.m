...
V = 2354.67417581 + ...
-0.0022488 *  ( ( ( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* 0.27991349)  - 12980.0)  .*  ( (0.03425926 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  - 80.66879711) ) )  + ...
0;

% MSE = 1.4560594708111222E-4
