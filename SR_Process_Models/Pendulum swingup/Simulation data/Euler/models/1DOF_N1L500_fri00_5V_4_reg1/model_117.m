...
V = -2230.60449833 + ...
0.05 *  ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) +  (12.12435565 +  (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) .* 19.0) ) )  +  (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + 44599.96561095) ) )  + ...
0;

% MSE = 8.690539726613485E-18
