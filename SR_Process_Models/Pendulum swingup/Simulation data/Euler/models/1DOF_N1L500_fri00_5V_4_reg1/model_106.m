...
V = 27.90917166 + ...
0.04997627 *  ( ( (-1.0 + ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  +  ( (-26.24513427 +  ( (-1.5 + ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  + -0.11402813) )  .* 20.00949401) ) )  + ...
0;

% MSE = 1.9319691518502806E-7
