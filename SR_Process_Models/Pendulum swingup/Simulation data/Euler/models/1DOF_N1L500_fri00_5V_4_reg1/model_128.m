...
V = 5.57002909 + ...
-0.05 *  ( (96.36977886 +  (-1.41421356 +  ( (16.4450165 - ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)))  -  (20.0 .* ((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) ) )  + ...
0;

% MSE = 8.690598518147094E-18
