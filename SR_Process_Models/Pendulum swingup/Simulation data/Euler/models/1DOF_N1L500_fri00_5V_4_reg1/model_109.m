...
V = 29.97701878 + ...
0.96977613 *  ( ( sin( sign( (((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + -1.0) ) )  -  (-0.967808 .*  ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 29.89458193)  .* 1.06538414) ) ) )  + ...
0;

% MSE = 0.19441497544168412
