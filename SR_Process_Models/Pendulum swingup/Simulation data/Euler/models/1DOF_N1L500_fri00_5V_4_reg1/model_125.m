...
V = 31.477554 + ...
452.99670185 *  ( ( ( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) + -31.28578692)  +  sin( (-2.89289322 -  sign(((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) )  .* 0.00220777) )  + ...
0;

% MSE = 0.19492942402281488
