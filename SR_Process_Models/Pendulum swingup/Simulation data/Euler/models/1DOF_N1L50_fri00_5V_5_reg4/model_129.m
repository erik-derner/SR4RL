...
V = 2.06291471 + ...
100.65639086 *  ( (-0.02049462 +  (((x1*0.0 * 1.0 + x2*0.0 * 1.0 + x3*1.0 * 1.0 + 0.0 * 1.0)) .* 0.015625) ) )  + ...
-12.97923384 *  ( ( sin( (((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0)) - 0.0) )  .* 0.48668967) )  + ...
-0.2369404 *  ( sign(((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-9.17043616 *  ( (-0.13235175 .*  (0.75 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 1.9030239993578267E-16
