...
V = 5.28161143 + ...
-296.86774102 *  ( (-0.00529783 .* ((x1*0.0 * 1.0 + x2*0.0 * 1.0 + x3*1.0 * 1.0 + 0.0 * 1.0))) )  + ...
-6.31746832 *  ( (0.99990355 .*  (0.99567579 +  sin(((x1*1.0 * 1.0 + x2*0.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) ) )  + ...
-0.2369404 *  ( sign(((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) )  + ...
-1.01086158 *  ( (-0.99710207 -  (0.90051148 .* ((x1*0.0 * 1.0 + x2*1.0 * 1.0 + x3*0.0 * 1.0 + 0.0 * 1.0))) ) )  + ...
0;

% MSE = 2.0096936327696602E-16
